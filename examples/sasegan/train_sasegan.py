...
parser.add_argument("--nfx", default=False, action="store_true", help="Choose numpy features extractor")
...
dataset = SeganTrainDataset(
    ...
    noisy_dir=config.learning_config.dataset_config.noisy_train_paths,
...
segan_trainer.compile(generator, discriminator, config.learning_config.optimizer_config, max_to_keep=args.max_ckpts)
